...
class BTexecutor : public  rclcpp::Node{
    public: 
        ...
        : Node("bt_executor"), bt_node_(bt_node){
            ...
            //std::string relative_tree_path = config["path_trees"]["main_qr"].as<std::string>();
            //std::string relative_tree_path = config["path_trees"]["docking_qr"].as<std::string>();
            std::string relative_tree_path = config["path_trees"]["bt_command"].as<std::string>();
