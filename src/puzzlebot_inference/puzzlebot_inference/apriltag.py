...
try:
    ...
    raise ImportError("Instala pupil-apriltags: pip install pupil-apriltags")
...
class AprilTagDetector(Node):
    def __init__(self):
        ...
        # pose en el frame de la camara
        self.pub_pose_cam = self.create_publisher(PoseStamped, 'apriltag/pose', 10)
        # pose en base_footprint
        self.pub_pose_base = self.create_publisher(PoseStamped, 'apriltag/pose_base_footprint', 10)
    ...
    def _publish_in_base_footprint(self, pose_cam: PoseStamped):
        try:
            # tiempo cero = usa el TF mas reciente disponible
